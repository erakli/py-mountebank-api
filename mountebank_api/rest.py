...
from mountebank_api.exceptions import ApiException, ApiValueError
...
class RESTClientObject(object):
    ...
    def __init__(self, configuration, pools_size=4, maxsize=None):
        ...
        self.default_timeout = configuration.default_timeout
    ...
    async def request(self, method, url, query_params=None, headers=None,
        ...
        data_repr = ""
        if 'data' in args and hasattr(args['data'], '__getitem__'):
            data_repr = f"data_len={len(args['data'])} data={args['data'][:1000]}"
        ...
        if _preload_content:
            ...
            # log response body
            logger.debug("response body: %s", r.data[:1000])
